...
mongodb_1.MongoClient.connect('mongodb://localhost:27017', {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, doctorsDAO_1.DoctorsDAO.injectDB(client)];
            case 1:
                _a.sent();
                return [4 /*yield*/, visitsDAO_1.VisitsDAO.injectDB(client)];
            case 2:
                _a.sent();
                return [4 /*yield*/, clinicsDAO_1.ClinicsDAO.injectDB(client)];
            case 3:
                _a.sent();
                return [4 /*yield*/, usersDAO_1.UsersDAO.injectDB(client)];
            case 4:
                _a.sent();
